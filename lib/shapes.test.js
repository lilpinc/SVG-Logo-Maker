...
describe("Triangle test", () => {
    test("test for a red triangle", () => {
      ...
      expect(triangle.render()).toEqual(
        `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><polygon  points="200,10 300,190 100,190" fill="red"/><g><text x="200" y="165" text-anchor="middle" font-size="60" fill="white">EXP</text></g></svg>`
      );
    });
  });
  // check square
